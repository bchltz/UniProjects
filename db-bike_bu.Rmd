...
Hier kommen noch die Pipelines

# Data understanding

## Import data

Load the data from two different sources and store them in a RData file for performance issues.

```{r}

# Import the RData file which contains the df_tageswerte data set

load(file = "/Users/victorbucholtz/Documents/Dokumente/University/01_Applied_Statistics/R/bike_dwd.RData")
...
dateday = day of booking
CITY_RENTAL_ZONE = Location (City) of the individual bike station
rentals = amount of daily rentals
dauer = mean duration of rentals for the specific day
wochentag = weekday
QN_3
FX = Maximum of the wind peak
FM = Average of the wind peak
QN_4
Niederschlag = Precipitation level
RSKF = Precipitation type
SDK = Sunshine duration daily total
SHK_TAG = Snow height daily value	
NM = Daily mean of the degree of coverage
VPM = Daily average of steam pressure	
PM = Daily average air pressure	
TMK = Daily average temperature	
UPM = Daily average of relative humidity	
Temperatur = Daily maximum of the air temperature
TNK = Daily minimum of air temperature in 2m height	
TGK = Minimum air temperature on the ground at a height of 5cm
