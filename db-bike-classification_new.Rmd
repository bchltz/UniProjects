...
#df_feiertage <- read_csv("/Users/victorbucholtz/Documents/Dokumente/University/01_Applied_Statistics/R/Feiertage_Hamburg.csv")
df_feiertage <- read_csv("Feiertage_Hamburg.csv")
#df_schulferien <- read_csv("/Users/victorbucholtz/Documents/Dokumente/University/01_Applied_Statistics/R/Schulferien_Hamburg.csv")
...
As our results show, the performance of the "XGBoost" model is best on the training data across almost all parameters. In the Business Understanding we have chosen "F1" as the selection parameter. So we will choose XGBoost and train and evaluate the test data with it.
```{r}
Ergebnisse_class
```
